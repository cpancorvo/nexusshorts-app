      ...
      <div className="max-w-[1400px] mx-auto px-8 py-16">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-12 mb-16">
          <div className="col-span-2">
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="font-display text-xl text-bone tracking-tightest">
                nexusshorts<span className="text-acid">.studio</span>
              </span>
            </div>
            <p className="text-fog text-sm max-w-xs leading-relaxed">
              An automated film studio that fits in a browser tab. Built for
              creators who would rather not be on camera.
            </p>
          </div>

          <div>
            <h4 className="font-mono text-xs uppercase tracking-widest text-acid mb-4">
              Product
            </h4>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-chalk">
              ...
              <li><Link href="#" className="hover:text-acid transition-colors">DPA</Link></li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-smoke pt-8 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div className="font-mono text-xs text-fog">
            © 2026 NexusShorts Labs Inc. — Made for creators who don&apos;t film.
          </div>
          <div className="font-mono text-xs text-fog flex items-center gap-2">
            <span className="w-2 h-2 bg-acid rounded-full pulse-dot"></span>
