    ...
    <header className="fixed top-0 left-0 right-0 z-50 backdrop-blur-md bg-ink/70 border-b border-smoke/50">
      <div className="max-w-[1400px] mx-auto px-8 h-16 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-10 font-mono text-xs uppercase tracking-widest text-fog">
          <Link href="/#how" className="hover:text-bone transition-colors">
            01 — Process
          </Link>
          <Link href="/#showcase" className="hover:text-bone transition-colors">
            02 — Work
          </Link>
        ...
        <div className="flex items-center gap-3">
          <Link
            href="/dashboard"
            className="hidden md:block text-sm text-fog hover:text-bone transition-colors"
          >
            Sign in
          </Link>
          <Link
            href="/dashboard"
            className="bg-acid text-ink px-4 py-2 font-mono text-xs uppercase tracking-wider font-medium hover:bg-bone transition-colors"
          >
            Start free →
          </Link>
        </div>
